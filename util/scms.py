...
class SCM:
    ...
    Args:
        ...
        generate_func (Callable[[PRNGKey, int], jnp.ndarray]): Function that generates the data.

    Attributes:
        data (jnp.ndarray): Data generated by the SCM.
    """
...
def linear_backdoor():
    def generate(key: PRNGKey, n_samples: int) -> np.ndarray:
        ...
        y = - x + 3 * t + jax.random.normal(keys[3], shape=(n_samples, 1)) * 2
